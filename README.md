...
- [条件格式化设计](docs/conditional-format-design.md) — 4 种规则 × 双模隔离 × 双 scope 的完整设计
- [P5+ UI 小变更](docs/ui-features-p5.md) — 字段类型 icon / 合计-小计互斥 / 设置面板归属
